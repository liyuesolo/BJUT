...
<c:import url="./common_left.jsp"></c:import>
    <!-- 左侧可伸缩菜单栏结束 -->
		...
		<ul class="nav nav-tabs">
            <li class="active"><a href="ReadNotificationServlet?code=display">已查看</a></li>
            <li><a href="NotificationServlet?code=display">未查看</a></li>
        </ul>
		        ...
		        <table class="table table-striped table-bordered">
		            <caption>
		                <ul class="pagination pagination-sm" style="float:left;">
		                    <li title="第一页"><a href="ReadNotificationServlet?code=display">&laquo;</a></li>
		                    <li title="上一页"><a href="ReadNotificationServlet?code=${currentPageNum*(-1)}">&lsaquo;</a></li>
		                    <li title="当前页" class="active"><a href="#"><c:out value="${requestScope.currentPageNum}"/></a></li>
		                    <li title="下一页"><a href="ReadNotificationServlet?code=${currentPageNum}">&rsaquo;</a></li>
		                    <li title="最末页"><a href="ReadNotificationServlet?code=lastPage">&raquo;</a></li>
		                    <li>
